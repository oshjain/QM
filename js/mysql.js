var tempSQL = {	
	constructor: function(){
        ...
        // handle all updates on sql tablese
...
var SQL = {
	...
	//	Function to Create a derived table from two or more tables
	derived: function(fields, from, where, groupBy){
		var s = squel.select()
				
	
	},
	
	handleSQLupdate: function(){
